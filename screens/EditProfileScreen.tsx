...
interface EditProfileScreenProps {
  ...
  onSave: (updatedProfile: { name: string; photo: string; district: string }) => void;
  onCancel: () => void;
}

const EditProfileScreen: React.FC<EditProfileScreenProps> = ({ profile, onSave, onCancel }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
        ...
        <div className="flex items-center p-3 border-b border-gray-200 bg-surface">
            ...
            <h1 className="font-poppins text-xl text-text-primary ml-4">Edit Profile</h1>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center p-6 overflow-y-auto">
          <div className="w-full max-w-sm">
            ...
            <button 
              onClick={() => onSave({ name, photo, district })}
